...
@section('title','Add Customer | Kasir Application')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Customer</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      <li><a class="treeview-item active" href="{{url('admin/customer/create')}}"><i class="icon fa fa-circle-o"></i> Add Customer</a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                ...
                <select name="gender" class="form-control demoSelect">
