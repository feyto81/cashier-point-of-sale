...
<ul class="app-menu">
  ...
  @endif
  @if(auth()->user()->level_id == '1')
  <li><a class="app-menu__item active" href="{{url('admin/users')}}"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Users</span></a></li>
  @endif
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> List User</h1>
