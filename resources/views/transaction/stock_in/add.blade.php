...
@section('title','Add Stock In | Kasir Application')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-shopping-cart"></i><span class="app-menu__label">Transaction</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('admin/stock-in')}}"><i class="icon fa fa-circle-o"></i> Stock In</a></li>
...
<main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <form action="{{url('admin/stock-in/store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
            ...
            <div class="tile-footer">
              ...
              <a href="{{url('admin/stock-in')}}" class="btn btn-warning btn-flat">
